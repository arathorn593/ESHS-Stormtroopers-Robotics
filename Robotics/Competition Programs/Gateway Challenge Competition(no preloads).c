   ...
   while((SensorValue[encoderLeft] + SensorValue[encoderRight])/2 > 0)  //go back
{
  ...
  while((SensorValue[encoderLeft] + SensorValue[encoderRight])/2 < distance/2)  //go forward specified distance to pick up three objects
{
      motor[frontLeft] = 127 + leftAdjust;
      motor[backLeft] = 127 + leftAdjust;
      motor[frontRight] = 127 + rightAdjust;
 ...
 if (SensorValue[team]  == 1)                //  decides what team robot is on!!!
    ...
    while ((SensorValue[encoderLeft]) > -350 && (SensorValue[encoderRight] < 350 ))
      {
        ...
        if (SensorValue[encoderLeft] > -350)
          {
      motor[frontLeft] = -127 - leftAdjust;
      motor[backLeft] = -127 - leftAdjust;
          }
      ...
      motor[backLeft] = 0;
        ...
        if (SensorValue[encoderLeft] < 350)
        {
      motor[frontRight] = 127 + leftAdjust;
      motor[backRight] = 127 + leftAdjust;
        }
        else
        {
      motor[frontRight] = 0;
...
else
{
 ...
 while((SensorValue[encoderLeft] + SensorValue[encoderRight])/2 < distance/2)  //go forward specified distance to pick up two objects
{
      motor[frontLeft] = 127 + leftAdjust;
      motor[backLeft] = 127 + leftAdjust;
      motor[frontRight] = 127 + rightAdjust;
   ...
   while((SensorValue[encoderLeft] + SensorValue[encoderRight])/2 > 0)  //go back
{
    ...
    motor[beltRight2] = 0;
       ...
       while((SensorValue[encoderLeft] + SensorValue[encoderRight])/2 > distance/2)  //go back
{
      motor[frontLeft] = -127 - leftAdjust;
      motor[backLeft] = -127 - leftAdjust;
      motor[frontRight] = -127 - rightAdjust;
