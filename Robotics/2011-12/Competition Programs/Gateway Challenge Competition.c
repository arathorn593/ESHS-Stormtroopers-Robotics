...
// following function.
//ds;lasfjjlasjkdf;laljsdjf;alsjdjf5
/////////////////////////////////////////////////////////////////////////////////////////
...
task autonomous()
{
  ...
  // .....................................................................................
/*
jumper in 11 if blue
jumper in 12 if in iso
*/
...

{
  ...
  motor[liftLeft] = 0;
    ...
    motor[frontLeft] = 95 + leftAdjust;
      motor[backLeft] = 95 + leftAdjust;
      motor[frontRight] = 95 + rightAdjust;
      motor[backRight] = 95 + rightAdjust;
     wait1Msec(1000);
  ...
  while((SensorValue[encoderLeft] + SensorValue[encoderRight])/2 > 0)           //go back
   ...
   motor[frontLeft] = 0;
      ...
      while(SensorValue[encoderArm] > 55)                                             //lower arm
  {
    motor[liftLeft] = -127;
    motor[liftRight] = -127;
  }
